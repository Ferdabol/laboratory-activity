    ...
    return (
      <div className="max-w-4xl mx-auto text-center py-12">
        <div className="bg-white rounded-lg shadow-md p-8">
          <svg
            className="w-20 h-20 mx-auto mb-4 text-[#E0C097]"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <article className="bg-white rounded-lg shadow-xl overflow-hidden mb-8">
        ...
        <div className="p-8">
          {/* Category */}
          {post.category && (
            <span className="inline-block bg-[#B85C38] text-white text-sm font-semibold px-4 py-1 rounded-full mb-4">
              {post.category}
            </span>
          )}

          {/* Title */}
          <h1 className="text-4xl font-bold text-[#5C3D2E] mb-4 font-['Merriweather']">
            {post.title}
          </h1>
            ...
            {post.isOwner && (
              <div className="flex gap-3">
                <Link to={`/posts/${id}/edit`}>
                  <SecondaryButton className="px-4 py-2">
                    Edit
                  </SecondaryButton>
                </Link>
                <DangerButton
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-[#2D2424] leading-relaxed whitespace-pre-wrap text-lg">
              {post.content}
            </p>
          </div>
